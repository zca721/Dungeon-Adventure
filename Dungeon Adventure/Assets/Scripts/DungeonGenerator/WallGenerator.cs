...
public static class WallGenerator {
    ...
    private static void CreateBasicWalls(TilemapVisualizer tilemapVisualizer, HashSet<Vector2Int> basicWallPositions, HashSet<Vector2Int> floorPositions) {
        foreach (var position in basicWallPositions) {
            ...
            if (neighboursBinaryType == "1001") {   // Debug Test***** Works!!!
                tilemapVisualizer.PaintSingleCornerWallSpecialCase(position, neighboursBinaryType);
            } else if (neighboursBinaryType == "1100") {    // Debug Test***** Works!!!
                tilemapVisualizer.PaintSingleCornerWallSpecialCase(position, neighboursBinaryType);
            } else {
