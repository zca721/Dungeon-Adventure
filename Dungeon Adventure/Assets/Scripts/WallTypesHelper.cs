...
public class WallTypesHelper : MonoBehaviour
{
    ...
    public static HashSet<int> wallInnerCornerDownLeftSpecial = new HashSet<int>
    {
        0b1100,     // Debug Test***** Works!!!
    };
    ...
    public static HashSet<int> wallInnerCornerDownRightSpecial = new HashSet<int>
    {
        0b1001,     // Debug Test***** Works!!!
    };
